...
import formStyles from "@/components/AddForm/AddForm.module.scss"
   ...
   return (
      <Modal className={styles.modal} isOpen={isOpen} id="root">
         ...
         <div className={clsx(formStyles.footer, styles.footer)}>
            <Image height={50} width={50} src="/images/themes/theme11.jpg" alt="image" draggable={false} className={styles.image}/>
