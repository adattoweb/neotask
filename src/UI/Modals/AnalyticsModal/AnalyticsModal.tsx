   ...
   return (
      <div className={styles.progress} style={{ width: size, height: size }}>
         <svg width={size} height={size} style={{ transform: "rotate(-90deg)" }}>
            ...
            <circle cx={size / 2} cy={size / 2} r={r} stroke="#000" strokeWidth={stroke} fill="none" strokeDasharray={c} strokeDashoffset={o} strokeLinecap="round" style={{ transition: "stroke-dashoffset .35s" }} />
         </svg>
   ...
   return (
      <FormProvider {...methods}>
         <Modal className={styles.analytics} isOpen={modals.isAnalyticsOpen} id="root">
            ...
            <Controller name="frequency" control={methods.control} defaultValue="daily" render={({ field }) => (
            ...
            <CircularProgress progress={50} size={width <= 480 ? 100 : width <= 768 ? 120 : 150} stroke={width <= 480 ? 7 : 9}>
